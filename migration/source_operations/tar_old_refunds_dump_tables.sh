...
pg_dump --data-only -h applications.preprod.internal -U refunds_master_full --file=applications.tar --format=t applications
...
echo "cases"
$dump_cmd -U cases_full --format=t --file=cases.tar cases
echo "caseworker"
$dump_cmd -U cases_full --format=t --file=caseworker.tar caseworker
echo "finance"
$dump_cmd -U cases_full --format=t --file=finance.tar finance
echo "meris"
$dump_cmd -U cases_full --format=t --file=meris.tar meris


export PGPASSWORD=${SIRIUS_DB_PASS}
echo "sirius"
$dump_cmd -U sirius_full --format=t --file=sirius.tar sirius
