\set DATABASE_NAME `echo ${OPG_REFUNDS_DB_FINANCE_NAME}`
\set DATABASE_FULL_USERNAME `echo ${OPG_REFUNDS_DB_FINANCE_FULL_USERNAME}`
\set DATABASE_FULL_PASSWORD `echo ${OPG_REFUNDS_DB_FINANCE_FULL_PASSWORD}`
\set DATABASE_MIGRATION_USERNAME `echo ${OPG_REFUNDS_DB_FINANCE_MIGRATION_USERNAME}`
\set DATABASE_MIGRATION_PASSWORD `echo ${OPG_REFUNDS_DB_FINANCE_MIGRATION_PASSWORD}`
