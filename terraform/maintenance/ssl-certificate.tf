...
resource "aws_route53_record" "certificate_validation_maintenance_cloudfront_san_wildcard" {
  provider = aws.old_refunds_production
...
resource "aws_acm_certificate_validation" "maintenance_cloudfront" {
  ...
  validation_record_fqdns = [
    ...
    aws_route53_record.certificate_validation_maintenance_cloudfront_san_wildcard.fqdn,
  ]
}
...
resource "aws_acm_certificate" "maintenance_cloudfront" {
  ...
  subject_alternative_names = ["*.claim-power-of-attorney-refund.service.gov.uk"]
